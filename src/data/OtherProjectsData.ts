...
export default [
    new ProjectData("project-6", "Tile TFT", "img/projects/TileTFT.png", `
    <div class="paragraph">
        Tile TFT
    </div>
    ...
    new ProjectData("project-7", "Zuma", "img/projects/zuma.png", `
        <div class="paragraph">
         ...
         <div class="paragraph center">
            <iframe class="youtube" src="https://youtube.com/embed/fumYh4ADiGs" frameborder="0" allowfullscreen></iframe>
        </div>
        <div class="paragraph center">
    ...
    new ProjectData("project-8", "All in Hole", "img/projects/all-in-hole.png", `
        <div class="paragraph">
         ...
         <div class="paragraph center">
            <iframe class="youtube" src="https://youtube.com/embed/7n4YxyH5L6A" frameborder="0" allowfullscreen></iframe>
        </div>
        <div class="paragraph center">
    ...
    new ProjectData("project-9", "Fixel by number", "img/projects/pixel-number.png", `
        <div class="paragraph">
         ...
         <div class="paragraph center">
            <iframe class="youtube" src="https://youtube.com/embed/m_Zj1LZirJo" frameborder="0" allowfullscreen></iframe>
        </div>
        <div class="paragraph center">
    ...
    new ProjectData("project-10", "Water Sort", "img/projects/water.png", `
        <div class="paragraph">
         ...
         <div class="paragraph center">
            <iframe class="youtube" src="https://youtube.com/embed/pfQG10X7lpQ" frameborder="0" allowfullscreen></iframe>
        </div>
        <div class="paragraph center">
